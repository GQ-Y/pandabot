...
import { removeAckReactionAfterReply, shouldAckReaction } from "pandabot/plugin-sdk";
import type { PandaConfig, PluginRuntime } from "pandabot/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/panda") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
