...
Nostr DM channel plugin for Pandabot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Pandabot. It enables your bot to:
...
```bash
pandabot plugins install @pandabot/nostr
```
...
# Configure pandabot to use local relay
