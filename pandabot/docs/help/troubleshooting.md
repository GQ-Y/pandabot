...
You can also set `PANDABOT_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `panda config get agents.defaults.models`
...
If you can, include the relevant log tail from `panda logs --follow`.
