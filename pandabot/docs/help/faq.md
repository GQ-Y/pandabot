---
summary: "Frequently asked questions about Panda setup, configuration, and usage"
---
# FAQ
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up Panda?](#whats-the-recommended-way-to-install-and-set-up-panda)
  ...
  - [I can't access docs.molt.bot (SSL error). What now?](#i-cant-access-docspanda-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or panda not recognized](#windows-install-says-git-not-found-or-panda-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Panda on Linux?](#how-do-i-install-panda-on-linux)
  - [How do I install Panda on a VPS?](#how-do-i-install-panda-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Clawd to update itself?](#can-i-ask-panda-to-update-itself)
  ...
  - [If I buy a Mac mini to run Panda, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-panda-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Pandas?](#can-multiple-people-use-one-whatsapp-number-with-different-pandas)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Panda on a dedicated machine?](#how-important-is-it-to-run-panda-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Panda in a VM and what are the requirements](#can-i-run-panda-in-a-vm-and-what-are-the-requirements)
- [What is Panda?](#what-is-panda)
  - [What is Panda, in one paragraph?](#what-is-panda-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Panda](#what-are-the-top-five-everyday-use-cases-for-panda)
  - [Can Panda help with lead gen outreach ads and blogs for a SaaS](#can-panda-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Panda run tasks on a schedule or continuously in the background?](#can-panda-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Panda saved locally?](#is-all-data-used-with-panda-saved-locally)
  - [Where does Panda store its data?](#where-does-panda-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Panda?](#how-do-i-completely-uninstall-panda)
...
- [Config basics](#config-basics)
  ...
  - [Can the Panda browser run headless?](#can-the-panda-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two Pandas talk to each other (local + VPS)?](#can-two-pandas-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Panda load environment variables?](#how-does-panda-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of Pandas one CEO and many agents](#is-there-a-way-to-make-a-team-of-pandas-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Panda but keep it installed?](#how-do-i-completely-reset-panda-but-keep-it-installed)
  ...
  - [Why doesn’t Panda reply in a group?](#why-doesnt-panda-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Clawd, Flawd, and Krill use for models?](#what-do-panda-flawd-and-krill-use-for-models)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `panda gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-panda-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `panda gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-panda-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Panda in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-panda-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Panda?](#i-closed-my-terminal-on-windows-how-do-i-restart-panda)
  ...
  - [ELI5: `panda gateway restart` vs `panda gateway`](#eli5-panda-gateway-restart-vs-panda-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Panda to inbound DMs?](#is-it-safe-to-expose-panda-to-inbound-dms)
...
5) **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/panda/panda-*.log | head -1)"
   ```
...
7) **Gateway snapshot**
   ```bash
   panda health --json
   panda health --verbose   # shows the target URL + config path on errors
   ```
...
This installs Panda **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/pandabot/pandabot/issues
https://github.com/pandabot/pandabot/pulls
...
What they do:
- `panda status`: quick snapshot of gateway/agent health + basic config.
- `panda models status`: checks provider auth + model availability.
- `panda doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `panda status --all`, `panda logs --follow`,
`panda gateway status`, `panda health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Whats the recommended way to install and set up Panda
...
If you don’t have a global install yet, run it via `pnpm panda onboard`.
...
- If it asks for auth, run `panda dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `PANDABOT_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**
- **Tailscale Serve** (recommended): keep bind loopback, run `panda gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `panda gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `panda dashboard`.
...
1) Install Panda on the new machine.
2) Copy `$PANDABOT_STATE_DIR` (default: `~/.pandabot`) from the old machine.
3) Copy your workspace (default: `~/panda`).
4) Run `panda doctor` and restart the Gateway service.
...
under `~/.pandabot/` (for example `~/.pandabot/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-panda-store-its-data),
...
https://github.com/pandabot/pandabot/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docspanda SSL error What now
...
detail: [Troubleshooting](/help/troubleshooting#docspanda-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/pandabot/pandabot/tree/main/docs
...
### Windows install says git not found or panda not recognized
...
**2) panda is not recognized after install**
...
### How do I install Panda on Linux
...
### How do I install Panda on a VPS
...
panda update
panda update status
panda update --channel stable|beta|dev
panda update --tag <dist-tag|version>
panda update --no-restart
```

If you must automate from an agent:

```bash
panda update --yes --no-restart
panda gateway restart
```
...
`panda onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Panda with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `panda models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `panda models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `panda models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. Panda no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Panda can keep replying while a provider is rate‑limited.
...
Panda supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Panda fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `panda.json`.

Steps:
1) Enable the plugin: `panda plugins enable google-gemini-cli-auth`
2) Login: `panda models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Panda needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Panda runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. Panda’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run Panda can I connect it to my MacBook Pro
...
- Use `panda nodes status` / `panda nodes list` to see it.
...
- DM your bot, then run `panda logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Pandas
...
If you run Panda via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the Panda code install. Your state
(`~/.pandabot`) and workspace (`~/panda`) stay untouched.
...
**Panda-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Panda on a dedicated machine
...
Panda is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Panda in a VM and what are the requirements
...
### What is Panda in one paragraph

Panda is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Whats the value proposition

Panda is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Panda
...
### Can Panda help with lead gen outreach ads and blogs for a SaaS
...
Panda draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Panda is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Panda when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.pandabot/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.pandabot/panda.json`). Precedence is `<workspace>/skills` > `~/.pandabot/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.pandabot/panda.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.pandabot/skills` → bundled → `skills.load.extraDirs`. `pandahub` installs into `./skills` by default, which Panda treats as `<workspace>/skills`.
...
Checklist:
- Confirm cron is enabled (`cron.enabled`) and `PANDABOT_SKIP_CRON` is not set.
- Check the Gateway is running 24/7 (no sleep/restarts).
- Verify timezone settings for the job (`--tz` vs host timezone).

Debug:
```bash
panda cron run <jobId> --force
panda cron runs --id <jobId> --limit 50
```
...
Browse skills at https://pandahub.com.
...
### Can Panda run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.panda.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-panda-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Panda can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3) Override the skill metadata (workspace or `~/.pandabot/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: {"panda":{"os":["darwin","linux"],"requires":{"bins":["imsg"]}}}
   ---
   ```
4) Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (Panda only needs stdio). See [iMessage](/channels/imessage).
...
```bash
pandahub install <skill-slug>
pandahub update --all
```

ClawdHub installs into `./skills` under your current directory (or falls back to your configured Panda workspace); Panda treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.pandabot/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawdHub](/tools/pandahub).
...
Panda memory is just Markdown files in the agent workspace:
- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Panda also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, Panda auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Panda
prefers `local`.
...
### Is all data used with Panda saved locally

No - **Panda’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.pandabot` + your workspace directory).
...
### Where does Panda store its data

Everything lives under `$PANDABOT_STATE_DIR` (default: `~/.pandabot`):

| Path | Purpose |
|------|---------|
| `$PANDABOT_STATE_DIR/panda.json` | Main config (JSON5) |
| `$PANDABOT_STATE_DIR/credentials/oauth.json` | Legacy OAuth import (copied into auth profiles on first use) |
| `$PANDABOT_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys) |
| `$PANDABOT_STATE_DIR/agents/<agentId>/agent/auth.json` | Runtime auth cache (managed automatically) |
| `$PANDABOT_STATE_DIR/credentials/` | Provider state (e.g. `whatsapp/<accountId>/creds.json`) |
| `$PANDABOT_STATE_DIR/agents/` | Per‑agent state (agentDir + sessions) |
| `$PANDABOT_STATE_DIR/agents/<agentId>/sessions/` | Conversation history & state (per agent) |
| `$PANDABOT_STATE_DIR/agents/<agentId>/sessions/sessions.json` | Session metadata (per agent) |

Legacy single‑agent path: `~/.pandabot/agent/*` (migrated by `panda doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/panda`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.pandabot`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.pandabot`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.pandabot/skills`).

Default workspace is `~/panda`, configurable via:
...
Do **not** commit anything under `~/.pandabot` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Panda
...
`workspace` to the repo root. The Panda repo is just source code; keep the
...
Panda reads an optional **JSON5** config from `$PANDABOT_CONFIG_PATH` (default: `~/.pandabot/panda.json`):

```
$PANDABOT_CONFIG_PATH
```

If the file is missing, it uses safe‑ish defaults (including a default workspace of `~/panda`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `PANDABOT_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `panda doctor --generate-gateway-token`.
...
key. **Recommended:** run `panda configure --section web` to store it in
...
- Daemons read env vars from `~/.pandabot/.env` (or the service environment).
...
### Can the Panda browser run headless
...
Check the basics:
- Gateway is running: `panda gateway status`
- Gateway health: `panda status`
- Channel health: `panda channels status`
...
### Can two Pandas talk to each other local VPS
...
`panda agent --message ... --deliver`, targeting a chat where the other bot
listens. If one bot is on a remote VPS, point your CLI at that remote Gateway
via SSH/Tailscale (see [Remote access](/gateway/remote)).

Example pattern (run from a machine that can reach the target Gateway):
```bash
panda agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
Recover:
- Restore from backup (git or a copied `~/.pandabot/panda.json`).
- If you have no backup, re-run `panda doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:
- Use `panda config set` for small changes.
- Use `panda configure` for interactive edits.
...
### How does Panda load environment variables

Panda reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.pandabot/.env` (aka `$PANDABOT_STATE_DIR/.env`)
...
1) Put the missing keys in `~/.pandabot/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`PANDABOT_LOAD_SHELL_ENV=1`, `PANDABOT_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`panda models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means Panda won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1) Put the token in `~/.pandabot/.env`:
   ```
...
### Is there a way to make a team of Pandas one CEO and many agents
...
### How do I completely reset Panda but keep it installed
...
```bash
panda reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `PANDABOT_PROFILE`), reset each state dir (defaults are `~/.pandabot-<profile>`).
- Dev reset: `panda gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Panda skips the heartbeat run to save API calls.
...
No. Panda runs on **your own account**, so if you’re in the group, Panda can see it.
...
```bash
panda directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Panda reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.pandabot/agents/<agentId>/sessions/`.
...
- Use `panda doctor` to spot stray workspaces and profile mismatches.
...
Panda’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, Panda currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `panda models set ...` (updates just model config)
- `panda configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.pandabot/panda.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `panda doctor` to repair.
...
Yes. Panda ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.pandabot/agents/<agentId>/agent/auth-profiles.json
```

Fix options:
- Run `panda agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Panda can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.pandabot/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.pandabot/agent/*` (migrated by `panda doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.pandabot/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `panda models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `panda models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `panda models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.pandabot/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    panda models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Panda will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: Panda now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Panda uses provider‑prefixed IDs like:
...
Panda may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `panda models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
panda models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
panda models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
panda models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
panda models auth order set --provider anthropic --agent main anthropic:default
```
...
```
--port > PANDABOT_GATEWAY_PORT > gateway.port > default 18789
```

### Why does panda gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `panda gateway status` and trust these lines:
- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does panda gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `PANDABOT_STATE_DIR` mismatch).

Fix:
```bash
panda gateway install --force
```
Run that from the same `--profile` / environment you want the service to use.

### What does another gateway instance is already listening mean

Panda enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `panda gateway --port <port>`.

### How do I run Panda in remote mode client connects to a Gateway elsewhere
...
Notes:
- `panda gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
Facts (from code):
- The Control UI stores the token in browser localStorage key `panda.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:
- Fastest: `panda dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `panda doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `PANDABOT_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `panda status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `PANDABOT_CONFIG_PATH` (per‑instance config)
- `PANDABOT_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):
- Use `panda --profile <name> …` per instance (auto-creates `~/.pandabot-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `panda --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.pandabot.*`, `panda-gateway-<profile>.service`, `Panda Gateway (<profile>)`).
...
```
panda tui --url ws://<host>:18789 --token <token>
```
...
- macOS: `$PANDABOT_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.pandabot/logs/...`; profiles use `~/.pandabot-<profile>/logs/...`)
- Linux: `journalctl --user -u panda-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Panda Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `panda gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Panda
...
1) Is the Gateway running? `panda gateway status`
2) Is the Gateway healthy? `panda status`
3) Does the UI have the right token? `panda dashboard`
...
```bash
panda channels status
panda channels logs --channel telegram
```
...
### ELI5 panda gateway restart vs panda gateway

- `panda gateway restart`: restarts the **background service** (launchd/systemd).
- `panda gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `panda gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Panda assistant setup](/start/panda) and [Agent send](/tools/agent-send).

CLI sending:

```bash
panda message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Panda to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `panda pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `panda pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `panda doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Panda only replies to chats it receives or to explicit sends you trigger.
...
Panda blocks **cross‑provider** messaging by default. If a tool call is bound
...
**A:** In Panda, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn’t find Anthropic credentials in the expected `auth-profiles.json` for the agent that’s running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/panda) or open a [GitHub discussion](https://github.com/pandabot/pandabot/discussions).
