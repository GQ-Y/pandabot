...
Panda treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.pandabot/settings/voicewake.json`

Shape:

```json
{ "triggers": ["panda", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
