...
This page ties together how Panda handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Panda keeps a
...
Panda separates the **prompt body** from the **command body**:
...
Panda can expose or hide model reasoning:
