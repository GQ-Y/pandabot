...
Panda has two separate “streaming” layers:
...
When block streaming is enabled, Panda can **merge consecutive block chunks**
...
When draft streaming is active, Panda disables block streaming for that reply to avoid double-streaming.
