...
- Install via CLI: `panda plugins install @panda/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `panda plugins install ./extensions/zalo`
   - From npm (if published): `panda plugins install @panda/zalo`
...
- Approve via:
  - `panda pairing list zalo`
  - `panda pairing approve zalo <CODE>`
...
- Example: `panda message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `panda channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `panda logs --follow`
