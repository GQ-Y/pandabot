...
- **gateway host** → `panda` process on the gateway machine
...
`~/.pandabot/exec-approvals.json` directly.

CLI: `panda approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
