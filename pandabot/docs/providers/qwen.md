---
summary: "Use Qwen OAuth (free tier) in Panda"
read_when:
  - You want to use Qwen with Panda
...
```bash
panda models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Panda will sync credentials
