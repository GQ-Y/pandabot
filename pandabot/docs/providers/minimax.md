---
summary: "Use MiniMax M2.1 in Panda"
read_when:
  - You want MiniMax models in Panda
...
Configure manually via `panda.json`:
...
- Use `panda models list` and `panda models set minimax/MiniMax-M2.1` to switch.
...
- Running `panda configure` and selecting **MiniMax M2.1**, or
