...
You can point Panda at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Panda
...
- [Anthropic provider](/providers/anthropic) - Native Panda integration with Claude setup-token or API keys
