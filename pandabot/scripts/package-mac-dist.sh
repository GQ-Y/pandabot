...
# Output:
# - dist/Pandabot.app
# - dist/Panda-<version>.zip
# - dist/Panda-<version>.dmg
...
APP="$ROOT_DIR/dist/Pandabot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Panda-$VERSION.zip"
DMG="$ROOT_DIR/dist/Panda-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Panda-$VERSION.notary.zip"
