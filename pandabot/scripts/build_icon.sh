...
# Defaults target the Panda assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Panda/Resources/Panda.icns"}
