...
export DISPLAY=:1
export HOME=/tmp/panda-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${PANDABOT_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${PANDABOT_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${PANDABOT_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${PANDABOT_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${PANDABOT_BROWSER_HEADLESS:-0}"
