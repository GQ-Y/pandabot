...
export const zh: TranslationDict = {
  ...
  config: {
    ...
    schemaUnavailableRaw: '架构不可用。请使用原始模式。',
    channelSchemaUnavailable: '渠道配置架构不可用。',
    schemaUnavailable: '架构不可用。',
    unsupportedSchemaUseRaw: '不支持的架构。请使用原始模式。',
    unsupportedSchemaNode: '不支持的架构节点。请使用原始模式。',
    unsupportedTypeRaw: '不支持的类型：{{type}}。请使用原始模式。',
  ...
  channels: {
    ...
    telegramSubtitle: '机器人状态和渠道配置。',
    discordSubtitle: 'Discord 机器人状态。',
    googlechatSubtitle: 'Google Chat 状态。',
    slackSubtitle: 'Slack 状态。',
    signalSubtitle: 'Signal 状态。',
    imessageSubtitle: 'macOS 桥接状态和渠道配置。',
    nostrSubtitle: 'Nostr 状态。',
    ...
    about: '关于',
    nip05: 'NIP-05',
    noProfileSet: '未设置资料。点击「编辑资料」添加名称、简介与头像。',
    profilePicture: '资料图片',
    name: '名称',
  ...
  debug: {
    ...
    securityAudit: '安全审计：',
    securityCritical: '个严重',
    securityWarnings: '个警告',
    securityNoCritical: '无严重问题',
    securityInfo: '条信息',
