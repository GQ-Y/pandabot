...
export const en: TranslationDict = {
  ...
  config: {
    ...
    unsupportedTypeRaw: 'Unsupported type: {{type}}. Use Raw mode.',
  ...
  channels: {
    ...
    discordSubtitle: 'Discord bot status.',
    googlechatSubtitle: 'Google Chat status.',
    slackSubtitle: 'Slack status.',
    signalSubtitle: 'Signal status.',
    imessageSubtitle: 'macOS bridge status and channel configuration.',
    nostrSubtitle: 'Nostr status.',
    ...
    about: 'About',
    nip05: 'NIP-05',
    noProfileSet: 'No profile set. Click "Edit Profile" to add name, bio, and avatar.',
