...
export function renderCron(props: CronProps) {
  ...
  return html`
    <section class="grid grid-cols-2">
      <div class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            <div class="stat-label">${t("cron.jobsCountLabel")}</div>
            <div class="stat-value">${props.status?.jobs ?? t("common.na")}</div>
          </div>
          <div class="stat">
            <div class="stat-label">${t("cron.nextHeartbeat")}</div>
      ...
      <div class="card">
        ...
        <div class="form-grid" style="margin-top: 12px;">
          <label class="field">
            ...
            >
              <option value="main">${t("format.main")}</option>
              <option value="isolated">${t("format.isolated")}</option>
            </select>
          </label>
          <label class="field">
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="card-sub">${t("cron.runHistorySubtitle")} ${props.runsJobId ?? ""}</div>
