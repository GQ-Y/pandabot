...
function renderGenericChannelCard(
  ...
  return html`
    <div class="card">
      ...
      <div class="card-sub">${t("channels.channelStatusTitle")}</div>
      ${accountCountLabel}
...
function renderGenericAccount(account: ChannelAccountSnapshot) {
  const runningKey = deriveRunningStatus(account);
  const connectedKey = deriveConnectedStatus(account);
  const runningLabel = runningKey === "yes" ? t("common.yes") : runningKey === "no" ? t("common.no") : t("common.active");
  const connectedLabel = connectedKey === "yes" ? t("common.yes") : connectedKey === "no" ? t("common.no") : connectedKey === "active" ? t("common.active") : t("common.na");
