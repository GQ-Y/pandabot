...
export type ChannelAgentToolFactory = (params: { cfg?: PandaConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: PandaConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: PandaConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: PandaConfig }) => boolean;
  supportsCards?: (params: { cfg: PandaConfig }) => boolean;
