...
export function listChannelMessageActions(cfg: PandaConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: PandaConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: PandaConfig): boolean {
  for (const plugin of listChannelPlugins()) {
