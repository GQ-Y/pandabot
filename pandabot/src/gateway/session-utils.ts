...
import { type PandaConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: PandaConfig): string[] {
...
export function listAgentsForGateway(cfg: PandaConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: PandaConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: PandaConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: PandaConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: PandaConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: PandaConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: PandaConfig): GatewaySessionsDefaults {
