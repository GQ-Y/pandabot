...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "panda-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolvePandaPackageRoot } = await import("./panda-root.js");
    ...
    vi.mocked(resolvePandaPackageRoot).mockResolvedValue("/opt/panda");
