...
describe("createPandaCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createPandaCodingTools({
      config,
    ...
    const anthropicTools = createPandaCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createPandaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createPandaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
