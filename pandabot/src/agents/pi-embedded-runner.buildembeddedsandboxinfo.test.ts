...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies PandaConfig;

const _ensureModels = (cfg: PandaConfig, agentDir: string) =>
  ensurePandaModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/panda-sandbox",
      agentWorkspaceDir: "/tmp/panda-workspace",
      ...
      browser: {
        ...
        containerName: "panda-sbx-browser-test",
      },
