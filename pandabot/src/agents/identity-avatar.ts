...
function resolveAvatarSource(cfg: PandaConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: PandaConfig, agentId: string): AgentAvatarResolution {
