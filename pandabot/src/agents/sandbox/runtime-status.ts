...
function resolveMainSessionKeyForSandbox(params: { cfg?: PandaConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: PandaConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`panda sandbox explain --session ${runtime.sessionKey}`)}`,
  );
