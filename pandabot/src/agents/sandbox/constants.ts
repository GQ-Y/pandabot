...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".pandabot", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "panda-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "panda-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "panda-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "panda-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "panda-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".pandabot");
