...
import type { PandaConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: PandaConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: PandaConfig | undefined, pathStr: string): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "panda-bundled";
}

export function resolveBundledAllowlist(config?: PandaConfig): string[] | undefined {
