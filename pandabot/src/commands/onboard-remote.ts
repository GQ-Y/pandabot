  ...
  if (!hasBonjourTool) {
    await prompter.note(
      [
        ...
        "文档：https://docs.pandabot.cc/gateway/discovery",
      ].join("\n"),
      "发现",
    );
  }
      ...
      if (mode === "direct") {
        ...
        await prompter.note(
          [
            ...
            "文档：https://docs.pandabot.cc/gateway/remote",
          ].join("\n"),
          "SSH 隧道",
        );
      }
