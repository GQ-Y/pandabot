...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "panda-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<PandaConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<PandaConfig["telegram"]>>,
