...
const ensurePandaModelsJson = vi.fn().mockResolvedValue(undefined);
const resolvePandaAgentDir = vi.fn().mockReturnValue("/tmp/panda-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/panda-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensurePandaModelsJson,
}));
