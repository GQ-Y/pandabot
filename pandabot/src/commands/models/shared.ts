...
export async function updateConfig(
  mutator: (cfg: PandaConfig) => PandaConfig,
): Promise<PandaConfig> {
...
export function resolveModelTarget(params: { raw: string; cfg: PandaConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: PandaConfig): Set<string> {
