...
describe("onboard (non-interactive): gateway and remote auth", () => {
  const prev = {
    ...
    skipBrowser: process.env.PANDA_SKIP_BROWSER_CONTROL_SERVER,
    token: process.env.PANDA_GATEWAY_TOKEN,
    password: process.env.PANDA_GATEWAY_PASSWORD,
  };
  ...
  afterAll(async () => {
    ...
    process.env.PANDA_STATE_DIR = prev.stateDir;
    process.env.PANDA_CONFIG_PATH = prev.configPath;
    process.env.PANDA_SKIP_CHANNELS = prev.skipChannels;
    process.env.PANDA_SKIP_GMAIL_WATCHER = prev.skipGmail;
    process.env.PANDA_SKIP_CRON = prev.skipCron;
    process.env.PANDA_SKIP_CANVAS_HOST = prev.skipCanvas;
    process.env.PANDA_SKIP_BROWSER_CONTROL_SERVER = prev.skipBrowser;
    process.env.PANDA_GATEWAY_TOKEN = prev.token;
    process.env.PANDA_GATEWAY_PASSWORD = prev.password;
  });
