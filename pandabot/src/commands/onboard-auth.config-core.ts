...
export function applyZaiConfig(cfg: PandaConfig): PandaConfig {
...
export function applyOpenrouterProviderConfig(cfg: PandaConfig): PandaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: PandaConfig): PandaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: PandaConfig): PandaConfig {
...
export function applyOpenrouterConfig(cfg: PandaConfig): PandaConfig {
...
export function applyMoonshotProviderConfig(cfg: PandaConfig): PandaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: PandaConfig): PandaConfig {
...
export function applyKimiCodeProviderConfig(cfg: PandaConfig): PandaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: PandaConfig): PandaConfig {
...
export function applySyntheticProviderConfig(cfg: PandaConfig): PandaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: PandaConfig): PandaConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: PandaConfig): PandaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: PandaConfig): PandaConfig {
