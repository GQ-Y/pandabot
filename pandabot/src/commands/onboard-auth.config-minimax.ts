...
export function applyMinimaxProviderConfig(cfg: PandaConfig): PandaConfig {
...
export function applyMinimaxConfig(cfg: PandaConfig): PandaConfig {
...
export function applyMinimaxApiProviderConfig(
  ...
  const baseUrl = process.env.MINIMAX_BASE_URL?.trim() || MINIMAX_API_BASE_URL;
  providers.minimax = {
