...
export function listBindings(cfg: PandaConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: PandaConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: PandaConfig) {
