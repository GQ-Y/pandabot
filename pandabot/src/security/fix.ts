...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof PandaConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: PandaConfig; env: NodeJS.ProcessEnv }): {
  cfg: PandaConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
