...
describe("resolveSystemdUserUnitPath", () => {
  ...
  it("prefers PANDA_SYSTEMD_UNIT over PANDA_PROFILE", () => {
    const env = {
      HOME: "/home/test",
      PANDA_PROFILE: "jbphoenix",
      PANDA_SYSTEMD_UNIT: "custom-unit",
    };
    expect(resolveSystemdUserUnitPath(env)).toBe(
  ...
  it("handles PANDA_SYSTEMD_UNIT with .service suffix", () => {
    const env = {
      HOME: "/home/test",
      PANDA_SYSTEMD_UNIT: "custom-unit.service",
    };
    expect(resolveSystemdUserUnitPath(env)).toBe(
      "/home/test/.config/systemd/user/custom-unit.service",
    );
  ...
  it("trims whitespace from PANDA_SYSTEMD_UNIT", () => {
    const env = {
      HOME: "/home/test",
      PANDA_SYSTEMD_UNIT: "  custom-unit  ",
    };
