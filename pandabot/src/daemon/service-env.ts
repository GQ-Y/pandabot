...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    PANDA_STATE_DIR: env.PANDA_STATE_DIR,
    PANDA_CONFIG_PATH: env.PANDA_CONFIG_PATH,
    PANDA_GATEWAY_PORT: String(port),
    PANDA_GATEWAY_TOKEN: token,
    PANDA_LAUNCHD_LABEL: resolvedLaunchdLabel,
    PANDA_SYSTEMD_UNIT: systemdUnit,
    PANDA_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    PANDA_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    PANDA_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    PANDA_STATE_DIR: env.PANDA_STATE_DIR,
    PANDA_CONFIG_PATH: env.PANDA_CONFIG_PATH,
    PANDA_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    PANDA_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    PANDA_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    PANDA_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    PANDA_LOG_PREFIX: "node",
    PANDA_SERVICE_MARKER: NODE_SERVICE_MARKER,
    PANDA_SERVICE_KIND: NODE_SERVICE_KIND,
    PANDA_SERVICE_VERSION: VERSION,
  };
}
