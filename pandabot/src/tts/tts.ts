...
export function resolveTtsConfig(cfg: PandaConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.PANDA_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: PandaConfig): string | undefined {
