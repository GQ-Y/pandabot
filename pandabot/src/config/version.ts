...
export function parsePandaVersion(raw: string | null | undefined): PandaVersion | null {
  if (!raw) return null;
...
export function comparePandaVersions(
  a: string | null | undefined,
  b: string | null | undefined,
): number | null {
  const parsedA = parsePandaVersion(a);
  const parsedB = parsePandaVersion(b);
