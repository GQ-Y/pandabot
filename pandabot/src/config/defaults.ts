...
function resolveAnthropicDefaultAuthMode(cfg: PandaConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: PandaConfig): PandaConfig {
...
export function applyTalkApiKey(config: PandaConfig): PandaConfig {
...
export function applyModelDefaults(cfg: PandaConfig): PandaConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: PandaConfig): PandaConfig {
...
export function applyLoggingDefaults(cfg: PandaConfig): PandaConfig {
...
export function applyContextPruningDefaults(cfg: PandaConfig): PandaConfig {
...
export function applyCompactionDefaults(cfg: PandaConfig): PandaConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
