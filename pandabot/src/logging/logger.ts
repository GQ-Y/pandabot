...
export const DEFAULT_LOG_DIR = "/tmp/panda";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "panda.log"); // legacy single-file path

const LOG_PREFIX = "panda";
...
function resolveSettings(): ResolvedSettings {
  let cfg: PandaConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => PandaConfig;
      };
