...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@panda", { botUsername: "panda" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@panda args", {
        botUsername: "panda",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "panda" })).toBe(
      "/help@otherbot",
    );
  });
