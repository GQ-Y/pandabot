...
function resolveMentionPatterns(cfg: PandaConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: PandaConfig | undefined, agentId?: string): RegExp[] {
