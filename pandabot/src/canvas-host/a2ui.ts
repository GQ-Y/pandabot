...
export const A2UI_PATH = "/__pandabot__/a2ui";
export const CANVAS_HOST_PATH = "/__pandabot__/canvas";
export const CANVAS_WS_PATH = "/__panda/ws";
...
(() => {
  ...
  const handlerNames = ["pandabotCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Panda = globalThis.Panda ?? {};
  globalThis.Panda.postMessage = postToNode;
  globalThis.Panda.sendUserAction = sendUserAction;
  globalThis.pandaPostMessage = postToNode;
  globalThis.pandaSendUserAction = sendUserAction;
  globalThis.pandabotPostMessage = postToNode;
  globalThis.pandabotSendUserAction = sendUserAction;
