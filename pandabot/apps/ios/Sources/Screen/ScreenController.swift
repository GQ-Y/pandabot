...
final class ScreenController {
    ...
    /// Callback invoked when a panda:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = PandaKitResources.bundle
...
/// Handles navigation policy to intercept panda:// deep links from canvas
@MainActor
