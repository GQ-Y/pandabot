...
private let onboardingWizardLogger = Logger(subsystem: "bot.panda", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between PandaProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = PandaProtocol.AnyCodable
