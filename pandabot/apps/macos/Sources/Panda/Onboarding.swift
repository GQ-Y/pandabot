...
enum UIStrings {
    static let welcomeTitle = "Welcome to Panda"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: PandaOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: PandaChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g panda@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: PandaChatViewModel(
