...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "bot.panda", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        PandaPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        PandaPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
