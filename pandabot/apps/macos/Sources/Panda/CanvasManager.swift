...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "bot.panda", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Panda/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__panda__/a2ui/").absoluteString + "?platform=macos"
    }
