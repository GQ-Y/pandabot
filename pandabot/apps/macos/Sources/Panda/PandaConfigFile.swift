...
enum PandaConfigFile {
    private static let logger = Logger(subsystem: "bot.panda", category: "config")

    static func url() -> URL {
        PandaPaths.configURL
    }

    static func stateDirURL() -> URL {
        PandaPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        PandaPaths.workspaceURL
    }
