...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "bot.panda", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Panda windows, but below the system’s pop-up menus.
