...
final class AppState {
    ...
    var onboardingSeen: Bool {
        didSet { self.ifNotPreview { UserDefaults.standard.set(self.onboardingSeen, forKey: "panda.onboardingSeen") }
        }
    }

    var debugPaneEnabled: Bool {
        didSet {
            self.ifNotPreview { UserDefaults.standard.set(self.debugPaneEnabled, forKey: "panda.debugPaneEnabled") }
    ...
    init(preview: Bool = false) {
        ...
        let onboardingSeen = UserDefaults.standard.bool(forKey: "panda.onboardingSeen")
        self.isPaused = UserDefaults.standard.bool(forKey: pauseDefaultsKey)
        self.launchAtLogin = false
        self.onboardingSeen = onboardingSeen
        self.debugPaneEnabled = UserDefaults.standard.bool(forKey: "panda.debugPaneEnabled")
        ...
        let configRoot = PandaConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = PandaConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = PandaConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/panda"
        state.remoteCliPath = ""
        return state
    }
}
