...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .pandaSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? PandaPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? PandaPaths.stateDirURL.path
...
extension Notification.Name {
    static let pandaSelectSettingsTab = Notification.Name("pandaSelectSettingsTab")
}
