...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "bot.panda", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: PandaPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = PandaPeekabooBridgeServices()
...
@MainActor
private final class PandaPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "bot.panda.peekaboo")
