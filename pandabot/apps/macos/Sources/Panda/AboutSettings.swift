...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/pandabot/pandabot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/pandabot/pandabot")
    ...
    private var buildTimestamp: String? {
        guard let raw = Bundle.main.object(forInfoDictionaryKey: "PandaBuildTimestamp") as? String
        else { return nil }
    ...
    private var gitCommit: String {
        Bundle.main.object(forInfoDictionaryKey: "PandaGitCommit") as? String ?? "unknown"
    }
