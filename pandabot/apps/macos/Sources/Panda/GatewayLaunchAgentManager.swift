...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "bot.panda", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".panda/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.pandaCommand(
            subcommand: "gateway",
