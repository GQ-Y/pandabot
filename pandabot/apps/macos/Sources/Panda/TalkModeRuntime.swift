...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "bot.panda", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "bot.panda", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [PandaChatMessage] = messages.compactMap { item in
