...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "bot.panda", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return PandaConfigFile.defaultWorkspaceURL() }
