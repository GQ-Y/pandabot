...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = PandaChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = PandaChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
