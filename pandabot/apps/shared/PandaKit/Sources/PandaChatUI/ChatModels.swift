...
public typealias PandaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias PandaPlatformImage = UIImage
#endif

public struct PandaChatUsageCost: Codable, Hashable, Sendable {
...
public struct PandaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: PandaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(PandaChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct PandaChatMessageContent: Codable, Hashable, Sendable {
...
public struct PandaChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [PandaChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: PandaChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [PandaChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: PandaChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(PandaChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([PandaChatMessageContent].self, forKey: .content) {
...
public struct PandaChatHistoryPayload: Codable, Sendable {
...
public struct PandaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct PandaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [PandaSessionPreviewItem]
}

public struct PandaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [PandaSessionPreviewEntry]

    public init(ts: Int, previews: [PandaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct PandaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct PandaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct PandaAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct PandaChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct PandaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct PandaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: PandaPlatformImage?
...
public struct PandaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
