...
@MainActor
public struct PandaChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: PandaChatViewModel
    ...
    private var visibleMessages: [PandaChatMessage] {
        let base: [PandaChatMessage]
    ...
    private func mergeToolResults(in messages: [PandaChatMessage]) -> [PandaChatMessage] {
    ...
    private func isToolResultMessage(_ message: PandaChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: PandaChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: PandaChatMessage) -> String {
