...
enum DeviceIdentityPaths {
    private static let stateDirEnv = "PANDABOT_STATE_DIR"
    ...
    static func stateDirURL() -> URL {
        ...
        if let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            return appSupport.appendingPathComponent("panda", isDirectory: true)
        }

        return FileManager.default.temporaryDirectory.appendingPathComponent("panda", isDirectory: true)
    }
}
