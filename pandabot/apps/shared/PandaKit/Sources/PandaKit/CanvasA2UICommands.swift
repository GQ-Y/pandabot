...
public enum PandaCanvasA2UICommand: String, Codable, Sendable {
...
public struct PandaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct PandaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
