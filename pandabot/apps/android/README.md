## Panda Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_panda-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm panda gateway --port 18789 --verbose
```
